// this is a class that contains the information of a series of airways that represents a symmetric airway tree. it will have attributes associated with it such as the current flow rate, the 
#include "airway_tree.h"
