...
QUEUE_TYPE=""              #"devel" is test and "" is just normal
JOB_NAME="arc_job"
WALLTIME="30:00:00"
NUM_NODES=1
...
# simulation parameters
OUTPUT_DIR_RELATIVE="error_tests/unrefined_32"
OUTPUT_DIR="$OUTPUT_BASE_DIR/$OUTPUT_DIR_RELATIVE"

MESH_BASE_DIR="$BASE_DIR"
MESH_BASE_DIR="/home/comp-respiratory-modelling/jmbewu/meshes-git/dphil_meshes"
...
SEMI_CONSTANT_VARIABLES="-mesh_file $MESH_BASE_DIR/meshes_for_paper/multi_bifurcation_symmetric_unstructured_2x2x2x2x2 -num_generations_string 32145415342145342154352143215342 -inflow_bdy_id 0 -no_refinement 2 -output_no_refinement 2 -preconditioner_type_3d1d 12 -unsteady 1 -dt 5.0 -write_interval 5.0 -end_time 500.0 -period 1000.0 -stokes false -reynolds_number 500 -sim_type 5 -twod_oned_tree true -threed false"
