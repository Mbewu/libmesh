...
# simulation parameters
OUTPUT_DIR_RELATIVE="particle_deposition_august/parameter_sweep/first_try/geom_2/ifr_10/fluid_sim/"
...
SEMI_CONSTANT_VARIABLES="-geometry_type 4 -mesh_file $MESH_BASE_DIR/meshes_for_deposition/multi_bifurcation_symmetric_diff_wall_bdy_2.msh -mesh_input_scaling_3d 0.02 -inflow_bdy_id 1011 -gmsh_diff_wall_bdy_id true -_read_1d_mesh false -num_generations_string 0 -num_generations 8 -twod_oned_tree true -threed false -stokes false -unsteady 1 -sim_type 5 -match_1d_to_3d_mesh true -reynolds_number_calculation false -prescribed_flow 0 -velocity_mag_3d 1.06103 -period 4.0 -end_time 2.0 -dt 0.01 -write_interval 0.01 -backup_write_interval 0.01 -nonlinear_tolerance 1e-6 -density 1.2 -viscosity 1.8e-5 -newton 1 -bifurcation_start_1d true -half_initial_length false -use_centreline_data true -input_1d_file  $MESH_BASE_DIR/meshes_for_deposition/multi_bifurcation_symmetric_diff_wall_bdy_2 -radius_on_edge false"
