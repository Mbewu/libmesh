...
# simulation parameters
OUTPUT_DIR_RELATIVE="particle_deposition_august/new_output/particle_3d0d_unsteady/"
...
SEMI_CONSTANT_VARIABLES="-geometry_type 4 -mesh_file $MESH_BASE_DIR/surface_mesh_22.5_bdylayer_ref.msh -mesh_input_scaling_3d 0.01 -inflow_bdy_id 1011 -no_refinement 0 -output_no_refinement 0 -threed true -_read_1d_mesh false -num_generations_string 2222 -twod_oned_tree false -alveolated_1d_tree 0 -viscosity 1.8e-5 -density 1.2 -output_nondim false -match_1d_to_3d_mesh true -stokes true -output_nondim false -match_1d_mesh_to_3d_mesh false -unsteady 0 -sim_type 3 -reynolds_number_calculation false -particle_deposition 6 -restart_folder $OUTPUT_BASE_DIR/particle_deposition_august/new_output/unsteady_3d0d/monolithic/ -unsteady_from_steady false -read_time_steps false -read_time_step_size 0.1 -write_interval 0.001"
