...
# simulation parameters
OUTPUT_DIR_RELATIVE="particle_deposition_august/new_output/output_0d_real_ped/"
...
SEMI_CONSTANT_VARIABLES="-_read_1d_mesh true -num_1d_trees 1 -input_1d_file $MESH_BASE_DIR/APLE0036266/output_airways_full -radius_on_edge false -mesh_input_scaling_1d 1.e-3 -twod_oned_tree false -alveolated_1d_tree 0 -threed true -flow_mag_1d 1000.0e-6 -viscosity 1.8e-5 -density 1.2 -stokes true -output_nondim false -match_1d_mesh_to_3d_mesh false -unsteady 0 -sim_type 1 -reynolds_number_calculation false -resistance_type_1d 1"
