...
# simulation parameters
OUTPUT_DIR_RELATIVE="particle_deposition_august/new_output/particle_2d0d/"
...
SEMI_CONSTANT_VARIABLES="-geometry_type 4 -mesh_file $MESH_BASE_DIR/meshes_for_paper/multi_bifurcation_symmetric_2.msh -mesh_input_scaling_3d 0.01 -inflow_bdy_id 1011 -_read_1d_mesh false -num_generations_string 2222 -twod_oned_tree false -alveolated_1d_tree 0 -viscosity 1.8e-5 -density 1.2 -output_nondim false -match_1d_to_3d_mesh true -threed false -stokes false -unsteady 0 -write_interval 0.01 -sim_type 3 -reynolds_number_calculation false -prescribed_flow 1 -flow_mag_3d 150.0e-6 -max_newton_iterations 5 -nonlinear_tolerance 1e-2 -backup_write_interval 0.01 -restart_folder $OUTPUT_BASE_DIR/particle_deposition_august/new_output/output_2d0d/monolithic/ -particle_deposition 4"
