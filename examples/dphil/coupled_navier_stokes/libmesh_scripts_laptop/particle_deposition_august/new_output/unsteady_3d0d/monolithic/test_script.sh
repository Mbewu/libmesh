...
# simulation parameters
OUTPUT_DIR_RELATIVE="particle_deposition_august/new_output/unsteady_3d0d/monolithic"
...
SEMI_CONSTANT_VARIABLES="-geometry_type 4 -mesh_file $MESH_BASE_DIR/surface_mesh_22.5_bdylayer_ref.msh -mesh_input_scaling_3d 0.01 -inflow_bdy_id 1011 -no_refinement 0 -output_no_refinement 0 -threed true -stokes true -_read_1d_mesh false -num_generations_string 2222 -twod_oned_tree false -alveolated_1d_tree 0 -viscosity 1.8e-5 -density 1.2 -output_nondim false -match_1d_to_3d_mesh true false -unsteady 1 -dt 0.1 -period 2.0 -end_time 1.0 -write_interval 0.1 -sim_type 5 -reynolds_number_calculation false -prescribed_flow 0 -velocity_mag_3d 100.0e-2 -max_newton_iterations 5 -nonlinear_tolerance 1e-2 -backup_write_interval 0.1"
