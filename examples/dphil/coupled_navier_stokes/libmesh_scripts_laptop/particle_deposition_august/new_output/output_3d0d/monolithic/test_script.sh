...
# simulation parameters
OUTPUT_DIR_RELATIVE="particle_deposition_august/new_output/output_3d0d/monolithic"
...
SEMI_CONSTANT_VARIABLES="-geometry_type 4 -mesh_file $MESH_BASE_DIR/surface_mesh_22.5_bdylayer_ref.msh -mesh_input_scaling_3d 0.01 -inflow_bdy_id 1011 -no_refinement 0 -output_no_refinement 0 -threed true -_read_1d_mesh false -num_generations_string 2222 -twod_oned_tree true -alveolated_1d_tree 0 -viscosity 1.8e-5 -density 1.2 -output_nondim false -match_1d_to_3d_mesh true -threed false -stokes true -unsteady 0 -sim_type 5 -reynolds_number_calculation false -prescribed_flow 1 -flow_mag_3d 150.0e-6 -max_newton_iterations 5 -nonlinear_tolerance 1e-2"
