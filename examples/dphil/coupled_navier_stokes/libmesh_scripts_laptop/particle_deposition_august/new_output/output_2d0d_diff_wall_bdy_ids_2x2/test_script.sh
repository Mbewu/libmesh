...
# simulation parameters
OUTPUT_DIR_RELATIVE="particle_deposition_august/new_output/output_2d0d_diff_wall_bdy_ids_2x2/"
...
SEMI_CONSTANT_VARIABLES="-geometry_type 4 -mesh_file $MESH_BASE_DIR/meshes_for_paper/multi_bifurcation_symmetric_diff_wall_bdy_2x2.msh -mesh_input_scaling_3d 0.01 -inflow_bdy_id 1011 -gmsh_diff_wall_bdy_id true -_read_1d_mesh false -num_generations_string 22222222 -twod_oned_tree true -alveolated_1d_tree 0 -viscosity 1.8e-5 -density 1.2 -output_nondim false -match_1d_to_3d_mesh true -threed false -stokes false -unsteady 0 -sim_type 5 -reynolds_number_calculation false -prescribed_flow 1 -flow_mag_3d 150.0e-4 -max_newton_iterations 5 -nonlinear_tolerance 1e-2"
