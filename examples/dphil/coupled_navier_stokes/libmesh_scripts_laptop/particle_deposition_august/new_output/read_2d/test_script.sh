...
# simulation parameters
OUTPUT_DIR_RELATIVE="particle_deposition_august/new_output/read_2d/"
...
SEMI_CONSTANT_VARIABLES="-geometry_type 4 -mesh_file $MESH_BASE_DIR/meshes_for_paper/multi_bifurcation_symmetric_2.msh -mesh_input_scaling_3d 0.01 -inflow_bdy_id 1011 -threed false -stokes true -unsteady 1 -sim_type 0 -reynolds_number_calculation false -prescribed_flow 0 -velocity_mag_3d 100.0e-2 -restart_folder $OUTPUT_BASE_DIR/particle_deposition_august/new_output/output_2d/ -unsteady_from_steady true"
