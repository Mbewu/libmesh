...
# simulation parameters
OUTPUT_DIR_RELATIVE="particle_deposition_august/new_output/particle_3d/"
...
SEMI_CONSTANT_VARIABLES="-geometry_type 4 -mesh_file $MESH_BASE_DIR/surface_mesh_22.5_bdylayer_ref.msh -mesh_input_scaling_3d 0.01 -inflow_bdy_id 1011 -no_refinement 0 -output_no_refinement 0 -threed true -unsteady 0 -sim_type 0 -reynolds_number_calculation false -prescribed_flow 0 -velocity_mag_3d 100.0e-2 -restart_folder $OUTPUT_BASE_DIR/particle_deposition_august/new_output/output_3d/ -particle_deposition 1 -viscosity 1.8e-5 -density 1.2 -write_interval 0.01"
