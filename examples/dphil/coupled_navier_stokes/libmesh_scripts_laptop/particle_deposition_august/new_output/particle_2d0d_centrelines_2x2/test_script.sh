...
# simulation parameters
OUTPUT_DIR_RELATIVE="particle_deposition_august/new_output/particle_2d0d_centrelines_2x2/"
...
SEMI_CONSTANT_VARIABLES="-geometry_type 4 -mesh_file $MESH_BASE_DIR/meshes_for_paper/multi_bifurcation_symmetric_diff_wall_bdy_2x2.msh -mesh_input_scaling_3d 0.01 -inflow_bdy_id 1011 -gmsh_diff_wall_bdy_id true -_read_1d_mesh false -num_generations_string 22222222 -twod_oned_tree false -alveolated_1d_tree 0 -viscosity 1.8e-5 -density 1.2 -output_nondim false -match_1d_to_3d_mesh true -threed false -stokes true -output_nondim false -match_1d_mesh_to_3d_mesh false -unsteady 0 -sim_type 3 -reynolds_number_calculation false -particle_deposition 6 -restart_folder $OUTPUT_BASE_DIR/particle_deposition_august/new_output/output_2d0d_diff_wall_bdy_ids_2x2/ -unsteady_from_steady true -write_interval 0.001 -use_centreline_data true -input_1d_file  $MESH_BASE_DIR/meshes_for_paper/multi_bifurcation_symmetric_diff_wall_bdy_2x2 -radius_on_edge false"
