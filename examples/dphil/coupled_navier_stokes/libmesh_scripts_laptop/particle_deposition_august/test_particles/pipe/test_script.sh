...
# simulation parameters
OUTPUT_DIR_RELATIVE="particle_deposition_august/test_particles/pipe"
...
SEMI_CONSTANT_VARIABLES="-geometry_type 2 -cube_length 0.01 -cube_width 0.01 -no_refinement 4 -output_no_refinement 4 -threed false -stokes true -unsteady 0 -sim_type 0 -reynolds_number_calculation false -prescribed_flow 0 -velocity_mag_3d 100.0e-2 -restart_folder $OUTPUT_BASE_DIR/particle_deposition_august/fluid_2d/pipe/ -particle_deposition 1 -viscosity 1.8e-5 -density 1.2 -write_interval 0.01"
