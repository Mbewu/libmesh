...
# simulation parameters
OUTPUT_DIR_RELATIVE="particle_deposition_august/parabolic_particle_entry/0d/"
...
SEMI_CONSTANT_VARIABLES="-_read_1d_mesh false -num_generations_1 2 -num_generations_string 3 -num_1d_trees 1 -initial_segment_length 6.5e-2 -half_initial_length false -twod_oned_tree false -alveolated_1d_tree 0 -threed false -flow_mag_1d 150.0e-6 -viscosity 1.8e-5 -density 1.2 -stokes true -output_nondim false -match_1d_mesh_to_3d_mesh false -unsteady 0 -sim_type 1 -reynolds_number_calculation false -particle_deposition 5 -restart_folder $OUTPUT_BASE_DIR/particle_deposition_august/new_output/unsteady_0d/ -unsteady_from_steady false -read_time_steps false -read_time_step_size 0.1 -write_interval 0.001 -period 2.0 -end_time 1.0"
