...
# simulation parameters
OUTPUT_DIR_RELATIVE="particle_deposition_august/parabolic_particle_entry/2d/"
...
SEMI_CONSTANT_VARIABLES="-geometry_type 4 -mesh_file $MESH_BASE_DIR/meshes_for_paper/multi_bifurcation_symmetric_2.msh -mesh_input_scaling_3d 0.01 -inflow_bdy_id 1011 -threed false -stokes true -unsteady 0 -sim_type 0 -reynolds_number_calculation false -prescribed_flow 0 -velocity_mag_3d 100.0e-2 -restart_folder $OUTPUT_BASE_DIR/particle_deposition_august/new_output/unsteady_2d/ -particle_deposition 1 -viscosity 1.8e-5 -density 1.2 -write_interval 0.001 -unsteady_from_steady false -read_time_steps false -read_time_step_size 0.1 -particle_backup_write_interval 0.01 -particle_write_interval 0.01"
