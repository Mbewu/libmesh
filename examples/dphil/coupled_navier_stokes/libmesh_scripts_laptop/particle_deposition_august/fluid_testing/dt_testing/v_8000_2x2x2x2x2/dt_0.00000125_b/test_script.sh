...
# simulation parameters
OUTPUT_DIR_RELATIVE="particle_deposition_august/fluid_testing/dt_testing/v_8000_2x2x2x2x2/dt_0.00000125_b/"
...
SEMI_CONSTANT_VARIABLES="-geometry_type 4 -mesh_file $MESH_BASE_DIR/meshes_for_deposition/multi_bifurcation_symmetric_diff_wall_bdy_2x2x2x2x2.msh -mesh_input_scaling_3d 0.02 -inflow_bdy_id 1011 -gmsh_diff_wall_bdy_id true -threed false -stokes true -unsteady 0 -sim_type 0 -reynolds_number_calculation false -prescribed_flow 0 -velocity_mag_3d 100.0e-2 -restart_folder $OUTPUT_BASE_DIR/particle_deposition_august/fluid_testing/dt_testing/v_8000_2x2x2x2x2/fluid_sim/ -particle_deposition 1 -viscosity 1.8e-5 -density 1.2 -write_interval 0.01 -use_centreline_data true -num_1d_trees 1 -input_1d_file $MESH_BASE_DIR/meshes_for_deposition/multi_bifurcation_symmetric_diff_wall_bdy_2x2x2x2x2 -radius_on_edge false -twod_oned_tree false -alveolated_1d_tree 0 -_read_1d_mesh false -random_seed 1504621692"
