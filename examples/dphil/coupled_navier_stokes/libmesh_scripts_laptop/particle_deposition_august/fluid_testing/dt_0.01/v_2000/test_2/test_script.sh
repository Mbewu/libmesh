...
# simulation parameters
OUTPUT_DIR_RELATIVE="particle_deposition_august/fluid_testing/dt_0.01/v_2000/test_2/"
...
SEMI_CONSTANT_VARIABLES="-geometry_type 4 -mesh_file $MESH_BASE_DIR/meshes_for_paper/multi_bifurcation_symmetric_diff_wall_bdy.msh -mesh_input_scaling_3d 0.02 -inflow_bdy_id 1011 -gmsh_diff_wall_bdy_id true -threed false -stokes false -unsteady 1 -sim_type 0 -reynolds_number_calculation false -prescribed_flow 0 -velocity_mag_3d 2.0 -period 4.0 -end_time 2.0 -dt 0.01 -write_interval 0.1 -nonlinear_tolerance 1e-6 -density 1.2 -viscosity 1.8e-5 -newton 0"
