...
# simulation parameters
OUTPUT_DIR_RELATIVE="3d1d_testing/outlets_9/3d0d_real"
...
SEMI_CONSTANT_VARIABLES="-mesh_file $MESH_BASE_DIR/meshes_for_ns_study/volume_mesh_full_outlets_9_ref1.xda -no_refinement 0 -output_no_refinement 0 -input_1d_file $MESH_BASE_DIR/meshes_for_3d0d_coupling_test/APLE0027688_truncated_0d/outlets_9/output_airways_full_james"
