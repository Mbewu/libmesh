...
SEMI_CONSTANT_VARIABLES="-reynolds_number 500 -period 1000.0 -end_time 500.0 -mesh_file $MESH_BASE_DIR/meshes_for_paper/multi_bifurcation_symmetric_unstructured_2.msh -num_generations_string 99 -unsteady 0"
