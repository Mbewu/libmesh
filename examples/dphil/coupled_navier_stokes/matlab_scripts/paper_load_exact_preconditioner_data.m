...
preconditioner_type = cellstr(['diagonal/    '; 'schur_0d/    '; 'schur_stokes/']);
bc_type = cellstr(['asym/'; 'sym/ ']);
num_outlets = cellstr(['outlets_2/ '; 'outlets_8/ '; 'outlets_32/']);
time_steps = cellstr(['dt_0.1/  '; 'dt_0.01/ '; 'dt_0.001/']);
time_steps_double = [0.1;0.01;0.001];

base_folder = '~/libmesh-git/libmesh/examples/dphil/coupled_navier_stokes/results/results_for_paper/results_for_paper_linear_iterations/exact_preconditioner/';
