...
#ifndef LIBMESH_EXODUSII_IO_HELPER_EXTENDED_H
#define LIBMESH_EXODUSII_IO_HELPER_EXTENDED_H
...
namespace exII {
  extern "C" {
#include "libmesh/exodusII.h" // defines MAX_LINE_LENGTH, MAX_STR_LENGTH used later
  }
}

/**
 * This is the \p ExodusII_IO_Helper_Extended class.  This class hides the implementation
 * details of interfacing with the Exodus binary format.
 *
 * @author Johw W. Peterson, 2002.
 */
class ExodusII_IO_Helper_Extended : public ParallelObject
{
public:
   ...
   * Destructor.
   */
  virtual ~ExodusII_IO_Helper_Extended();
  ...
  /**
   * This is the \p ExodusII_IO_Helper_Extended Conversion class.  It provides
  ...
  /**
   * This is the \p ExodusII_IO_Helper_Extended NamesData class.
...
class ExodusII_IO_Helper_Extended::Conversion
{
public:
...
class ExodusII_IO_Helper_Extended::ElementMaps
{
public:
   ...
   */
  ExodusII_IO_Helper_Extended::Conversion assign_conversion(std::string type_str);

  /**
   * @returns a conversion object given an element type.
   */
  ExodusII_IO_Helper_Extended::Conversion assign_conversion(const ElemType type);
};
 ...
 */
class ExodusII_IO_Helper_Extended::NamesData
{
public:
  /**
...
#endif // LIBMESH_EXODUSII_IO_HELPER_EXTENDED_H
