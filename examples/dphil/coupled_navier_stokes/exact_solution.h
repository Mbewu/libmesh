#ifndef EXACT_SOLUTION_BOUNDARY_FUNCTION_H
#define EXACT_SOLUTION_BOUNDARY_FUNCTION_H
...
class ExactSolutionBoundaryFunction : public FunctionBase<Output>
{
private:
...
public:
   ...
   * Constructor.
   */
  ExactSolutionBoundaryFunction(EquationSystems& _es)
			:  es(&_es)	{};
